...
### 1.1. Новые требования для совместимости с LXC User Namespace
...
### Новые требования (Issue #4 - LXC User Namespace)
10. 🔧 **Автоматическое определение типа контейнера**: Различение privileged/unprivileged
11. 🔧 **Чтение LXC mapping**: Автоматическое получение UID/GID из конфига контейнера
12. 🔧 **Правильные опции монтирования**: uid/gid для CIFS, anonuid/anongid для NFS
13. 🔧 **Автоматическая настройка прав**: chown после монтирования с правильными UID/GID
14. 🔧 **Тест записи**: Проверка возможности записи root пользователем в контейнере
